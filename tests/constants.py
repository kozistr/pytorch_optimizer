...
OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    ...
    (Shampoo, {'lr': 1e-1, 'weight_decay': 1e-3, 'graft_type': 0, 'start_preconditioning_step': 1}, 50),
    (Shampoo, {'lr': 1e-1, 'weight_decay': 1e-3, 'graft_type': 1, 'start_preconditioning_step': 1}, 50),
    (Shampoo, {'lr': 1e-1, 'weight_decay': 1e-3, 'graft_type': 2, 'start_preconditioning_step': 1}, 50),
