...
ADAMD_SUPPORTED_OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    ...
    (AdaBelief, {'lr': 5e-1, 'weight_decay': 1e-3, 'rectify': True, 'adamd_debias': True}, 25),
    ...
    (DiffGrad, {'lr': 5e-1, 'weight_decay': 1e-3, 'adamd_debias': True}, 25),
    (DiffGrad, {'lr': 5e-1, 'weight_decay': 1e-3, 'rectify': True, 'adamd_debias': True}, 50),
    (Lamb, {'lr': 5e-1, 'weight_decay': 1e-3, 'rectify': True, 'adamd_debias': True}, 50),
    (RAdam, {'lr': 5e-1, 'weight_decay': 1e-3, 'adamd_debias': True}, 50),
    (Ranger, {'lr': 5e-1, 'weight_decay': 1e-3, 'adamd_debias': True}, 100),
