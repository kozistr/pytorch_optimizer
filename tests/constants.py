...
OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    ...
    (EmoNavi, {'lr': 5e-1, 'lr_max': 5e-1, 'lr_min': 2e-1, 'use_shadow': True}, 7),
    (EmoLynx, {'lr': 5e-1, 'lr_max': 5e-1, 'lr_min': 2e-1, 'use_shadow': True}, 7),
    (EmoFact, {'lr': 1e-1, 'lr_max': 5e-1, 'lr_min': 2e-1, 'use_shadow': True}, 7),
