...
OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    ...
    (Shampoo, {'lr': 1e-1, 'weight_decay': 1e-3, 'graft_type': 0}, 10),
    (Shampoo, {'lr': 1e-1, 'weight_decay': 1e-3, 'graft_type': 1}, 10),
    (Shampoo, {'lr': 1e-1, 'weight_decay': 1e-3, 'graft_type': 2}, 10),
    (Shampoo, {'lr': 1e-1, 'weight_decay': 1e-3, 'graft_type': 3}, 30),
    (Shampoo, {'lr': 1e-1, 'weight_decay': 1e-3, 'graft_type': 4}, 10),
    (Shampoo, {'lr': 1e-1, 'weight_decay': 1e-3, 'pre_conditioner_type': 1}, 10),
    (Shampoo, {'lr': 1e-1, 'weight_decay': 1e-3, 'inverse_exponent_override': 1}, 10),
    (Shampoo, {'lr': 1e-1, 'weight_decay': 1e-3, 'nesterov': False}, 10),
    (Shampoo, {'lr': 1e-1, 'weight_decay': 1e-3, 'decoupled_weight_decay': True}, 10),
    (Shampoo, {'lr': 1e-0, 'weight_decay': 1e-3, 'decoupled_learning_rate': False}, 10),
    (Shampoo, {'lr': 1e-1, 'weight_decay': 1e-3, 'moving_average_for_momentum': True}, 10),
    (PNM, {'lr': 3e-1}, 50),
