...
OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    ...
    (DAdaptAdam, {'lr': 2.0, 'weight_decay': 1e-3}, 50),
    ...
    # (DAdaptAdan, {'lr': 2.0, 'weight_decay': 1e-2}, 25),
    # (DAdaptAdan, {'lr': 2.0, 'weight_decay': 1e-2, 'weight_decouple': True}, 25),
    (AdamS, {'lr': 1.0, 'weight_decay': 1e-3}, 20),
    (AdamS, {'lr': 1.0, 'weight_decay': 1e-3, 'amsgrad': True}, 20),
    (AdaFactor, {'lr': 5e-1, 'weight_decay': 1e-3, 'scale_parameter': False}, 100),
