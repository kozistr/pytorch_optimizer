...
OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    ...
    (Ranger, {'lr': 2.5e0, 'weight_decay': 1e-3}, 50),
    (Ranger, {'lr': 5e0, 'weight_decay': 1e-3, 'degenerated_to_sgd': True}, 5),
    (Ranger21, {'lr': 7.5e-1, 'num_iterations': 100, 'weight_decay': 1e-3}, 100),
...
AMSBOUND_SUPPORTED_OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    (AdaBelief, {'lr': 5e-1, 'weight_decay': 1e-3, 'ams_bound': True}, 10),
    (AdaBound, {'lr': 1e0, 'gamma': 0.1, 'weight_decay': 1e-3, 'ams_bound': True}, 20),
    (AdaPNM, {'lr': 5e-1, 'weight_decay': 1e-3, 'ams_bound': True}, 10),
...
ADANORM_SUPPORTED_OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    (AdaBelief, {'lr': 5e-1, 'weight_decay': 1e-3, 'adanorm': True}, 5),
    ...
    (Lamb, {'lr': 1e-1, 'adanorm': True}, 5),
    (RAdam, {'lr': 5e0, 'weight_decay': 1e-3, 'adanorm': True}, 10),
    (Ranger, {'lr': 2.5e0, 'weight_decay': 1e-3, 'adanorm': True}, 50),
...
ADAMD_SUPPORTED_OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    ...
    (AdaBound, {'lr': 1e0, 'gamma': 0.1, 'weight_decay': 1e-3, 'adam_debias': True}, 20),
    ...
    (AdaMod, {'lr': 5e2, 'weight_decay': 1e-3, 'adam_debias': True}, 10),
