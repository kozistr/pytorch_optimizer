...
OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    ...
    (DiffGrad, {'lr': 5e-2, 'weight_decay': 1e-3, 'amsgrad': True}, 5),
...
ADANORM_SUPPORTED_OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    ...
    (Lamb, {'lr': 5e-2, 'adanorm': True}, 5),
    (RAdam, {'lr': 5e0, 'weight_decay': 1e-3, 'adanorm': True}, 5),
    (Ranger, {'lr': 5e-1, 'weight_decay': 1e-3, 'adanorm': True}, 25),
