...
OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    ...
    (Lamb, {'lr': 5e-1, 'weight_decay': 1e-3, 'adam': True, 'eps': 1e-8}, 25),
    (Lamb, {'lr': 5e-1, 'weight_decay': 1e-3, 'pre_norm': True, 'eps': 1e-8}, 25),
    (LARS, {'lr': 5e-1, 'weight_decay': 1e-3}, 25),
    (LARS, {'lr': 5e-1, 'nesterov': True}, 25),
    (RaLamb, {'lr': 5e-1, 'weight_decay': 1e-3}, 25),
    (RaLamb, {'lr': 5e-1, 'weight_decay': 1e-3, 'pre_norm': True}, 25),
    (RaLamb, {'lr': 5e-1, 'weight_decay': 1e-3, 'degenerated_to_sgd': True}, 25),
    ...
    (DAdaptAdaGrad, {'lr': 1.0, 'weight_decay': 1e-3}, 125),
    (DAdaptAdaGrad, {'lr': 1.0, 'weight_decay': 1e-3, 'momentum': 0.1}, 125),
...
ADAMD_SUPPORTED_OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    ...
    (AdaBelief, {'lr': 5e-1, 'weight_decay': 1e-3, 'adamd_debias': True}, 20),
    (AdaBelief, {'lr': 5e-1, 'weight_decay': 1e-3, 'rectify': True, 'adamd_debias': True}, 20),
    ...
    (RaLamb, {'lr': 5e-1, 'weight_decay': 1e-3, 'adamd_debias': True}, 10),
