...
OPTIMIZERS: List[Tuple[Any, Dict[str, Union[float, bool, int]], int]] = [
    ...
    (Muon, {'lr': 1e0, 'weight_decay': 1e-3, 'adam_lr': 2e0, 'adamw_wd': 1e-3, 'nesterov': True}, 10),
    (Muon, {'lr': 2e0, 'weight_decay': 1e-3, 'use_adjusted_lr': True, 'adam_lr': 2e0, 'adamw_wd': 1e-3}, 10),
    (AdaMuon, {'lr': 1e0, 'weight_decay': 1e-3, 'adam_lr': 2e0, 'adamw_wd': 1e-3}, 10),
    (AdaMuon, {'lr': 2e0, 'weight_decay': 1e-3, 'use_adjusted_lr': True, 'adam_lr': 2e0, 'adamw_wd': 1e-3}, 10),
